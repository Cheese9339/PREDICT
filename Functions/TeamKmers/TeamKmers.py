...
def main():
    # new_folder = "/home/hpc/chiayicheng/scratch/users/Kai/New_Kmer_Pipeline/Results/2025_02_24_TeamKmers01"
    #>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>#
    ...
    Pvalue_DF, CS_DF = CalculatePvalue.main(new_folder, TPGeneXKmerDF, TNGeneXKmerDF,
                                                            pThreshold=0.99, Comparison="Greater",
                                                            TPCSThreshold=0.75, TPTNCSThreshold=0.3)
